...
<head>
  <title>Lista de cancelados</title>
  <link
    rel="shortcut icon"
...
<body id="page-top">
    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Pedidos cancelados</li>
        </ol>
        <div class="card">
          <div class="card-body">
  ...
  <script src="/Maquetacion/js/JHDIII/pedido_1.js"></script>
