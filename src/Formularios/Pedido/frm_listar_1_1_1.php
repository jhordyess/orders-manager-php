...
<body id="page-top">
    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Deudas de pago</li>
        </ol>
        <div class="card">
          <div class="card-body">
            <a href="frm_alta_mod.php?v=" class="btn btn-outline-success">
              <i class="fas fa-plus"></i> Nuevo pedido</a>
            <a href="../../Reporte/LaTeX/Itinerario.php" class="btn btn-outline-info" target="_blank" id="iters">
              ...
              <div class="form-group col-md-3">
                ...
                <div class="row">
                  <div class="form-group col-md-9">
                    <input type="date" class="jch form-control">
                  </div>
                </div>
              </div>
              <div class="form-group col-md-3">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <select class="emi form-control">
                      <option value='-1'> - </option>
                      <option value='0'> hasta este sabado </option>
                      <option value='1'> hasta 1 semana </option>
                      <option value='2'> hasta 2 semanas </option>
                      <option value='3'> hasta 30 dias </option>
                    </select>
                  </div>
                  <div class="form-group col-md-6">
                    <input type="date" class="fch form-control">
                  </div>
                </div>
              </div>
            </div>
              ...
              <table class="display nowrap table table-bordered table-hover" id="registros" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_array($out)) {
                    ...
                    $testo = new DateTime($row[10]);
                    echo "<td data-order=" . $testo->getTimestamp() . ">" . $row[10] . "</td>";
                    echo "<td>" . $row[11] . "</td>";
                    echo "</tr>";
                  }
                  mysqli_close($con);
  ...
  <!--Estan los botones que..no autoescalables-->
  <!--botones Emergentes-->
  ...
  <script src="/Maquetacion/js/JHDIII/pedido_1_1_1.js"></script>
