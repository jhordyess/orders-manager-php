...
if ($ids == NULL) {
  ...
  $a = mysqli_fetch_array(mysqli_query($con, "SELECT t.talla FROM  `tallas` AS t WHERE t.idtallas=" . $ids[0]));
  $tipo = "Modificar talla";
  $nombre = "Modificar";
}
?>
<!DOCTYPE html>
          ...
          <div class="col-md-12">
            ...
            <form method="post" action='alta_mod.php?v=<?php echo $envi ?>'>
              ...
              <!--            <label>Apellido paterno :</label>
                <input class="form-control" type ="text" id="a2" name="a2" value=""/>-->
              <br />
              <br />
