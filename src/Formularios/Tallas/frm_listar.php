...
<body id="page-top">
        ...
        <div class="card">
          <div class="card-body">
            <a href="frm_alta_mod.php?v=" class="btn btn-outline-success">
              <i class="fas fa-plus"></i> Nueva talla</a>
          </div>
        </div>
        <div class="card">
          ...
          <div class="card-body">
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="talla" placeholder="XL">
                <i id="clrtalla" class='fas fa-times-circle'></i>
              </div>
            </div>
          </div>
        </div>
              ...
              <form method="post">
                ...
                <table class="display nowrap table table-bordered table-hover" id="registros" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    $query = "SELECT * from tallas order by idtallas ASC;";
  ...
  <script src="/Maquetacion/js/JHDIII/tallas.js"></script>
